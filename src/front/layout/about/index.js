            ...
            <div className="container" style={{marginTop:50}}>
                <div className="row">
                    ...
                    <div className="col-sm-4 d-flex align-items-center">
                        <img src="/assets/images/about/apple_cinema.jpg" alt width={300} />


                </div>
                <div className="col-sm-4" style={{marginTop:100,marginBottom:100}}>
                    <img src="/assets/images/about/htc_touch_hd.jpg" width={300} />
                </div>
