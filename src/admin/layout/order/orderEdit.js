...
function OrderEditPage() {
  ...
  const form_name = "form-order-edit"
      ...
      <div id="main">
        ...
        <div className="page-heading d-flex align-items-center justify-content-between">
          ...
          <div class="pull-right">
            <button onClick={editOrder} data-toggle="tooltip" title="" class="btn btn-primary me-2" data-original-title="Save"><i class="fa fa-save"></i></button>
            ...
            <div id="tab-customer-details" className={sectionTab == "#tab-customer-details" ? "mt-5" : "d-none"}>
                <div class="mb-4">
                    ...
                    <select id="order_currency_id" name="order_currency_id" class="form-control">
                        {currencies.map((currency) => (
                            <option value={currency.currency_id} selected={currency.currency_id == orderInfo.currency_id ? "selected" : ""}>{currency.name}</option>
                        ))}
                    </select>
                </div>   
                <div class="mb-4">
                    ...
                    <select id="order_customer_id" name="order_customer_id" class="form-control">
                        ...
                        {customers.map((customer) => (
                            <option value={customer.customer_id} selected={customer.customer_id == orderInfo.customer_id ? "selected" : ""}>{`${customer.first_name} ${customer.last_name}`}</option>
                        ))}
                    </select>
                </div>  
                {/* <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input
                        ...
                        defaultValue={orderInfo.first_name}
                    />
                </div>   
                <div class="mb-4">
                    ...
                    <input
                        ...
                        defaultValue={orderInfo.last_name}
                    />
                </div> 
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input
                        ...
                        defaultValue={orderInfo.telephone}
                    />
                </div> 
            </div>
                ...
                <div class="mb-4">
                    ...
                    <select id="order_country_id" name="order_country_id" class="form-control">
                        {countries.map((country) => (
                            <option value={country.country_id} selected={country.country_id == orderInfo.country_id ? "selected" : ""}>{country.name}</option>
                        ))}
                    </select>
                </div> 
                <div class="mb-4">
                    ...
                    <select id="order_payment_id" name="order_payment_id" class="form-control">
                        {payments.map((payment) => (
                            <option value={payment.payment_id} selected={payment.payment_id == orderInfo.payment_id ? "selected" : ""}>{payment.name}</option>
                        ))}
                    </select>
                </div> 
                <div class="mb-4">
                    ...
                    <select id="order_shipment_id" name="order_shipment_id" class="form-control">
                        {shipments.map((shipment) => (
                            <option value={shipment.shipping_id} selected={shipment.shipping_id == orderInfo.shipping_id ? "selected" : ""}>{shipment.name}</option>
                        ))}
                    </select>
                </div> 
                <div class="mb-4">
                    ...
                    <select id="order_order_status_id" name="order_order_status_id" class="form-control">
                        {orderStatuses.map(orderStatus => (
                            <option value={orderStatus.order_status_id} selected={orderStatus.order_status_id == orderInfo.order_status_id ? "selected" : ""}>{orderStatus.name}</option>
                        ))}
                    </select>
                </div> 
            </div>
