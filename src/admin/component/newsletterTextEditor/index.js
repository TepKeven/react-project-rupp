...
function NewsletterTextEditorComponent({tabName, description}) {
  ...
  return (
    <>
      ...
      <input type="text" name={`${tabName}`} value={editorContent.replace(/&lt;/g, "<").replace(/&gt;/g, ">")} className="d-none"/>
...
export default NewsletterTextEditorComponent;